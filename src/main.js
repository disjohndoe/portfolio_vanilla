...
import loadThreeComponents from './utils/three-loader';
import projectModel from './utils/project-model';

// Initialize loader first - this now shows the hero section immediately
loader();
...
document.addEventListener('DOMContentLoaded', () => {
  ...
  // Defer loading THREE.js components until hero is visible
  loadThreeComponents().catch(error => {
